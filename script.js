...
let metricInputs = document.querySelector('.metric-inputs');
let imperialInputs = document.querySelector('.imperial-inputs');
let heightInCms = document.getElementById('height-cm');
let weightInKgs = document.getElementById('weight-kg');
let heightInFeet = document.getElementById('height-feet');
let heightInInches = document.getElementById('height-inches');
let weightInStone = document.getElementById('weight-stone');
let weightInPounds = document.getElementById('weight-pounds');
...
let classificationValues = document.getElementById('classification-values');
// console.log(input);
